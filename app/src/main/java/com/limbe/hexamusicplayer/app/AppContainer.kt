...
class AppContainer(
    ...
    val addToQueueUseCase = AddToQueueUseCase(audioPlayer)
    val playNextUseCase = PlayNextUseCase(audioPlayer)
    val removeFromQueueUseCase = RemoveFromQueueUseCase(audioPlayer)
    val moveQueueItemUseCase = MoveQueueItemUseCase(audioPlayer)
