        ...
        return when {
            ...
            modelClass.isAssignableFrom(PlayerViewModel::class.java) -> {
                PlayerViewModel(
                    ...
                    addToQueueUseCase = container.addToQueueUseCase,
                    playNextUseCase = container.playNextUseCase,
                    removeFromQueueUseCase = container.removeFromQueueUseCase,
                    moveQueueItemUseCase = container.moveQueueItemUseCase,
